<template>
    <div class="grid col-span-1 justify-items-center relative">
        ...
        <span class="mt-5 mb-10 font-mono italic text-sm text-black text-center">{{ props.descricao }} </span>
        <button class="bg-yellow-100 hover:bg-yellow-200 text-black font-bold py-2 px-4 rounded-full flex items-center justify-center ml-6 cursor-pointer mb-10" @click.prevent="adicionar()"> <!-- ao clicar no botão chama a função adicionar -->
